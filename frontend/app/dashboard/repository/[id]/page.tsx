    ...
    <div className="flex items-center justify-between">
      <div>
        ...
        <div className="flex items-center gap-4 text-sm text-gray-400">
          ...
          {repo.mode && (
            <span className="px-2 py-0.5 rounded bg-gray-800 text-xs capitalize">
              {repo.mode.replace('_', ' ')}
            </span>
          )}
          {repo.last_analysis_at ? (
            ...
            <span className="text-yellow-500">Not analyzed yet</span>
          )}
        </div>
      </div>
...
async function VCISection({ id }: { id: string }) {
  ...
  if (!repo) {
    return <div className="text-gray-400">Repository not found</div>
  }
...
function HeaderSkeleton() {
  return (
    <div className="animate-pulse">
      <div className="h-6 w-64 bg-gray-800 rounded mb-2" />
...
function VCISkeleton() {
  return (
    <div className="grid gap-6 lg:grid-cols-2">
      <div className="h-48 bg-gray-900/50 rounded-xl border border-gray-800 animate-pulse" />
      <div className="h-48 bg-gray-900/50 rounded-xl border border-gray-800 animate-pulse" />
    </div>
  )
}
...
function IssuesSkeleton() {
  return (
    <div className="rounded-xl border border-gray-800 bg-gray-900/50 animate-pulse">
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="space-y-8">
          ...
          {/* VCI Section */}
          <section>
            <h2 className="text-lg font-semibold mb-4">Code Health</h2>
