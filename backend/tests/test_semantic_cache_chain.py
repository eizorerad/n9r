    ...
    **Validates: Requirements 6.1, 6.2, 6.3**
    ...
    def test_embeddings_completion_dispatches_semantic_cache(
        ...
        **Validates: Requirements 6.1**
        ...
        with patch('app.workers.embeddings._update_embeddings_state'), \
        ...
        **Validates: Requirements 6.2**
        ...
        with patch('app.workers.embeddings._update_embeddings_state'), \
            ...
            assert not semantic_cache_dispatched, (
                "compute_semantic_cache.delay() was called after embeddings failure, "
